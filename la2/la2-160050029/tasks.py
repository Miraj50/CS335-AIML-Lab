...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.3, 5, 30) # (out_nodes=2=# classes, alpha, batchSize, epochs)
...
def taskSemiCircle(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.1, 10, 30) # (out_nodes, alpha, batchSize, epochs)
...
def taskMnist():
	...
	nn1 = nn.NeuralNetwork(10, 0.1, 10, 20) # (out_nodes, alpha, batchSize, epochs)
	nn1.addLayer(FullyConnectedLayer(784, 20)) # Not minimal
...
def taskCifar10():	
	...
	nn1.addLayer(FullyConnectedLayer(144,30))
